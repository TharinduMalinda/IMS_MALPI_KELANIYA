...
public class studentUpdate extends javax.swing.JFrame {
    ...
    public boolean previousSMSstatus = false;
    ...
    public studentUpdate(Student stt) {
        ...
        if (dbConnn.checkSMSStatus(st.getStudentID())) {
            jCheckBox1.setSelected(false);
            
        } else {
            jCheckBox1.setSelected(true);
            previousSMSstatus = true;
        }
    ...
    void loadStudentUpdate() {
        try {
            ...
            if ((st.getAdmissionStatuse().equals("PAID"))) {
                ...
                jYOR1.setDate(sdf.parse(st.getAdmissionDate()));
            } else {
    ...
    private void initComponents() {
        ...
        jYOR1 = new com.toedter.calendar.JDateChooser();
        ...
        jCheckBox1.setSelected(true);
        jCheckBox1.setText("       SMS Enable");
        jCheckBox1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jCheckBox1ActionPerformed(evt);
            }
        });
        jPanel3.add(jCheckBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 320, -1, -1));
        ...
        jYOR1.setDateFormatString("yyyy-MM-dd");
        jYOR1.setPreferredSize(new java.awt.Dimension(6, 20));
                        ...
                        .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel12Layout.createSequentialGroup()
                                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(jYOR1, javax.swing.GroupLayout.PREFERRED_SIZE, 151, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(0, 0, Short.MAX_VALUE)))))
                .addContainerGap())
        );
        jPanel12Layout.setVerticalGroup(
            ...
            .addGroup(jPanel12Layout.createSequentialGroup()
                ...
                .addGap(20, 20, 20)
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jYOR1, javax.swing.GroupLayout.DEFAULT_SIZE, 25, Short.MAX_VALUE)
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-Select-", "Free", "Half", "Normal" }));
        ...
        cmbYear2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "2022" }));
...
public void loadSchool(String name) {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        // TODO add your handling code here:
        SimpleDateFormat sdf = new SimpleDateFormat("dd-MM-yyyy");
        String dob = sdf.format(jYOR1.getDate());
        int count = 0;
        ...
        try {
            ...
            if (result == 1) {
                ...
                count = dbConnn.makeAdmission(st.getStudentID(), admissionAmount, dob);
    ...
    private void UpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateActionPerformed
        ...
        try {
            ...
            if (dbConnn.checkSMSStatus(st.getStudentID())) {
                if(jCheckBox1.isSelected() && !previousSMSstatus){
                    dbConnn.UpdateSMSStatus(st.getStudentID(),"DACT",true);
                }else{
                    if(previousSMSstatus){// this means deactive the already activated sms facility
                        dbConnn.UpdateSMSStatus(st.getStudentID(),"DACT",false);
                    }
                    //do nothing
                }
                ...
                if(jCheckBox1.isSelected()){
                    ...
                    dbConnn.insertSMSDeactStudent(st);
                }
            }
    ...
    private com.toedter.calendar.JDateChooser jYOR1;
