                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(txtAddrs1, javax.swing.GroupLayout.PREFERRED_SIZE, 179, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(2, 2, 2))))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addContainerGap()
            ...
            if (!message.equals("")) {
                ...
                if (count > 0) {
                    if (!jCheckBox1.isSelected()) {
                        int countt = dbCon.insertSMSDeactStudent(st);
                        if (countt == 1) {

                        } else {
                            JOptionPane.showMessageDialog(new JFrame(), "Error in SMS Deactivation. Please update SMS Deact in Student Update window");
                        }

                    } else {
                        boolean x = dbCon.insertSMSPayments(st.getStudentID());
                        if (x) {
                            JOptionPane.showMessageDialog(new JFrame(), "Student Successfully Registered For SMS");
                        } else {
                            JOptionPane.showMessageDialog(new JFrame(), "Error in SMS Payment Creations.Please run Monthly Payment Account Creation Process");
                        }
                    }
