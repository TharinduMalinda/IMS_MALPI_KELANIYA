 ...
 * @author tharindu_m
 */
public class coursePaymentStatus extends javax.swing.JFrame {

    /**
     * Creates new form totalMonthlyIncome
     */
    public coursePaymentStatus() {
        initComponents();
...
//            stmt1.close();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Course Payment Status");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            a.put("amount", new reportDbConnection().getCourseFee(courseID)[0]);
            String month = (cmbMonth.getSelectedIndex()+1)+"".length()==1?"0"+(cmbMonth.getSelectedIndex()+1)+"":(cmbMonth.getSelectedIndex()+1)+"";
            a.put("dateCompare",cmbYear.getSelectedItem()+"-"+month+"-"+"30");

            ////temp code
            Config config = new Config();
            reportGen rg;
            try {
                rg = new reportGen(config.report_path +"WhoPaidForGivenMonth.jasper", a);
                rg.setVisible(true);
            } catch (Exception ex) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(coursePaymentStatus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new coursePaymentStatus().setVisible(true);
            }
        });
    }
