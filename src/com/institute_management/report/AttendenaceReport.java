...
public class AttendenaceReport extends javax.swing.JFrame {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(cmbCourseID, javax.swing.GroupLayout.PREFERRED_SIZE, 332, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cmbStdNameReg, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 241, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                    ...
                                    .addGap(19, 19, 19)
                                    .addComponent(cmbStdMobReg, javax.swing.GroupLayout.PREFERRED_SIZE, 241, javax.swing.GroupLayout.PREFERRED_SIZE))))))
                .addContainerGap())
        );
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        try {
            ...
            String query = "SELECT distinct `course_id` FROM `student-course` where status = 'ACT' and s_id  = " + cmbStdIDReg.getEditor().getItem().toString();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            if (to.getDate() == null || from.getDate() == null || cmbCourseID.getSelectedItem() == null || cmbStdIDReg.getSelectedItem() == null) {
                if (cmbStdIDReg.getSelectedItem() == null) {
                    JOptionPane.showMessageDialog(new JFrame(), "Please Select a Student");
                } else if (cmbCourseID.getSelectedItem() == null) {
                    JOptionPane.showMessageDialog(new JFrame(), "Please Select a Course");
                } else if (from.getDate() == null) {
                ...
                a.put("s_id", cmbStdIDReg.getSelectedItem().toString());
                a.put("s_name", cmbStdNameReg.getSelectedItem().toString());
