...
public class StudentPayments extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Student Payments Report");
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        try {
            ...
            String query = "SELECT distinct `course_id` FROM `student-course` where status = 'ACT' and s_id like '%" + cmbStdIDReg.getEditor().getItem().toString() + "%'";
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (to.getDate() == null || from.getDate() == null || cmbCourseID.getSelectedItem() == null || cmbStdIDReg.getSelectedItem() == null) {
            ...
            a.put("fromDate", from);
            a.put("toDate", to);
            a.put("course", cmbCourseID.getSelectedItem().toString());
            a.put("regID", cmbStdIDReg.getSelectedItem().toString());
        ...
        // SELECT * FROM `attendence` WHERE id>=(select min(id) from attendence where year >= 2017 and month >=5 and date >=25) and id<=(select max(id) from attendence where year <= 2017 and month <=5 and date <=25  )
            try {
                ...
                reportGen rg;
                try {
                    rg = new reportGen(config.report_path +"studentPaymentReport.jasper", a);
                    rg.setVisible(true);
                } catch (Exception ex) {
