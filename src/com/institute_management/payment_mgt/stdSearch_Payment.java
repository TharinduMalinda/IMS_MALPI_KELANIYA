 ...
 * @author malindad
 */
public class stdSearch_Payment extends javax.swing.JFrame {
    ...
    private void tblViewStudentMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblViewStudentMouseClicked
        ...
        if (i == 0) {
            this.dispose();
            new MainPage_Payment(reg_id).setVisible(true);
        }
        }catch(Exception ex){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(stdSearch_Payment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new stdSearch_Payment().setVisible(true);
            }
        });
    }
